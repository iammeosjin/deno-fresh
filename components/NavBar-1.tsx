...
export default function NavBar() {
	...
	return (
		<header class="fixed w-full bg-primary">
        ...
        <div id="menu" class="hidden lg:flex lg:items-center lg:w-auto w-full">
          <nav>
            <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
              <li><a href="#" class="lg:p-4 text-gray-800 hover:text-gray-900 font-bold">Home</a></li>
              <li><a href="#" class="lg:p-4 text-gray-800 hover:text-gray-900">About</a></li>
              <li><a href="#" class="lg:p-4 text-gray-800 hover:text-gray-900">Blog</a></li>
              <li><a href="#" class="lg:p-4 text-gray-800 hover:text-gray-900">Pricing</a></li>
            </ul>
          </nav>
        </div>
        <div class="">
          ...
          <div class="inline-flex md:hidden">
            <button id="menu-toggle" class="flex-none px-2 btn btn-white btn-sm">
              <svg
