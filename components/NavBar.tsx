            ...
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center lg:order-2">
                  ...
                  <div class="group inline-block lg:mr-0 ">
                    <button
                      class="min-w-min bg-red-600 hover:bg-red-700 outline-none focus:outline-none border-none px-3 py-1 rounded-full flex items-center"
                    >
                      <span>
                    ...
                    <ul
                      class="bg-transparent rounded-sm transform scale-0 group-hover:scale-100 absolute
                    ...
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                      {
                        navigations.map(navigation => {
                          ...
                          let navClass = `text-xl lg:hover:text-red-700 font-extrabold block py-2 pl-3 pr-4 text-gray-${props.path === '/' ? '200': '400'} border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:p-0`;
                          ...
                          return (
                            <li>
                                <a href={navigation.path} class={navClass}>{navigation.title}</a>
                            </li>
                          );
                        })
                      }
