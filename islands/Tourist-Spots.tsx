...
export default function TouristSpots(props: { spots: PostListProps[] }) {
	return (
				...
				<div class='row justify-center'>
					<div class='w-full lg:w-1/2'>
						<div class='section_title text-center pb-6'>
							<h5 class='sub_title'>Tourist Spots</h5>
							<h4 class='main_title'>
								Checkout Jasaan Best Tourist Spots
							</h4>
						</div>
						<div class='mb-1 order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4'>
							<a
								href='/spots?type=tourist_spot'
