		...
		<>
			...
			<body>
				<div className="bg-gradient-to-tr from-red-400 to-yellow-50 relative h-screen w-screen">
					<video className="absolute inset-0 w-full h-screen object-cover bg-video mix-blend-multiply filter brightness-50" playsInline={true} autoPlay={true} muted={true} loop={true}>
